            ...
            <Col span={24}>
              <FormItem {...formItemLayout} label="跟进时间">
                {getFieldDecorator('followUpDate', {
                  validateTrigger: 'onBlur',
                  rules: [{ type: 'object', required: true, message: '跟进时间不能为空!' }],
                })(<DatePicker placeholder="请输入跟进时间" />)}
              </FormItem>
            </Col>
            <Col span={24}>
            ...
            <Col span={24}>
              <FormItem {...formItemLayout} label="下次跟进时间">
                {getFieldDecorator('nextTime', {
                  validateTrigger: 'onBlur',
                  rules: [{ type: 'object', required: true, message: '下次跟进时间不能为空!' }],
                })(<DatePicker placeholder="请输入下次跟进时间" />)}
              </FormItem>
            </Col>
            <Col span={24}>
